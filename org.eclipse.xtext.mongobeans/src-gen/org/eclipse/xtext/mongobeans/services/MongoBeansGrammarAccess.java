...
package org.eclipse.xtext.mongobeans.services;
...
public class MongoBeansGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class MongoFileElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "MongoFile");
	...
	public class AbstractElementElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cMongoBeanParserRuleCall_2 = (RuleCall)cAlternatives.eContents().get(2);
		...
		//MongoBean
		public RuleCall getMongoBeanParserRuleCall_2() { return cMongoBeanParserRuleCall_2; }
	}
	...
	private MongoFileElements pMongoFile;
	private ImportElements pImport;
	private AbstractElementElements pAbstractElement;
	private PackageDeclarationElements pPackageDeclaration;
	private MongoBeanElements pMongoBean;
	private AbstractFeatureElements pAbstractFeature;
	private MongoPropertyElements pMongoProperty;
	private MongoOperationElements pMongoOperation;
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.eclipse.xtext.mongobeans.MongoBeans".equals(grammar.getName())) {
				return grammar;
			}
	...
	public MongoFileElements getMongoFileAccess() {
		return (pMongoFile != null) ? pMongoFile : (pMongoFile = new MongoFileElements());
	}

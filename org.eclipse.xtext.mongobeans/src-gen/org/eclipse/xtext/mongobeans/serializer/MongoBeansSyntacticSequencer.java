...
public class MongoBeansSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MongoBeansGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (MongoBeansGrammarAccess) access;

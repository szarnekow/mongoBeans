package org.eclipse.xtext.mongobeans.serializer;
...
public class MongoBeansSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == MongoBeansPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case MongoBeansPackage.MONGO_BEAN:
				if(context == grammarAccess.getAbstractElementRule() ||
				   context == grammarAccess.getMongoBeanRule()) {
					sequence_MongoBean(context, (MongoBean) semanticObject); 
					return; 
				}
				else break;
			case MongoBeansPackage.MONGO_FILE:
				if(context == grammarAccess.getMongoFileRule()) {
					sequence_MongoFile(context, (MongoFile) semanticObject); 
					return; 
				}
				else break;
			case MongoBeansPackage.MONGO_OPERATION:
				if(context == grammarAccess.getAbstractFeatureRule() ||
				   context == grammarAccess.getMongoOperationRule()) {
					sequence_MongoOperation(context, (MongoOperation) semanticObject); 
					return; 
				}
				else break;
			case MongoBeansPackage.MONGO_PROPERTY:
				if(context == grammarAccess.getAbstractFeatureRule() ||
				   context == grammarAccess.getMongoPropertyRule()) {
					sequence_MongoProperty(context, (MongoProperty) semanticObject); 
					return; 
				}
				else break;
	...
	protected void sequence_Import(EObject context, Import semanticObject) {
		if(errorAcceptor != null) {
			if(transientValues.isValueTransient(semanticObject, MongoBeansPackage.Literals.IMPORT__IMPORTED_NAMESPACE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, MongoBeansPackage.Literals.IMPORT__IMPORTED_NAMESPACE));
		}
	 ...
	 */
	protected void sequence_MongoBean(EObject context, MongoBean semanticObject) {
	 ...
	 */
	protected void sequence_MongoFile(EObject context, MongoFile semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_MongoOperation(EObject context, MongoOperation semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}

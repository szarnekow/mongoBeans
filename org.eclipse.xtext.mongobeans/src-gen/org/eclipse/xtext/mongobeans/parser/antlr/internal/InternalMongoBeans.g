...
entryRuleMongoFile returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMongoFileRule()); }
	 iv_ruleMongoFile=ruleMongoFile 
	 { $current=$iv_ruleMongoFile.current; } 
	 EOF 
;

// Rule MongoFile
ruleMongoFile returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
...
(
    ...
    { 
        $current = $this_MongoBean_2.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
entryRuleMongoBean returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMongoBeanRule()); }
	 iv_ruleMongoBean=ruleMongoBean 
	 { $current=$iv_ruleMongoBean.current; } 
	 EOF 
;

// Rule MongoBean
ruleMongoBean returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
entryRuleMongoProperty returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMongoPropertyRule()); }
	 iv_ruleMongoProperty=ruleMongoProperty 
	 { $current=$iv_ruleMongoProperty.current; } 
	 EOF 
;

// Rule MongoProperty
ruleMongoProperty returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
...
entryRuleMongoOperation returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMongoOperationRule()); }
	 iv_ruleMongoOperation=ruleMongoOperation 
	 { $current=$iv_ruleMongoOperation.current; } 
	 EOF 
;

// Rule MongoOperation
ruleMongoOperation returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((((

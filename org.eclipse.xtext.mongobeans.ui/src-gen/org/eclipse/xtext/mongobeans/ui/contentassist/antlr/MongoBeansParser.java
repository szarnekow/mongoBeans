...
* generated by Xtext
*/
package org.eclipse.xtext.mongobeans.ui.contentassist.antlr;
...
public class MongoBeansParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.xtext.mongobeans.ui.contentassist.antlr.internal.InternalMongoBeansParser createParser() {
		org.eclipse.xtext.mongobeans.ui.contentassist.antlr.internal.InternalMongoBeansParser result = new org.eclipse.xtext.mongobeans.ui.contentassist.antlr.internal.InternalMongoBeansParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMongoBeanAccess().getGroup(), "rule__MongoBean__Group__0");
					put(grammarAccess.getMongoPropertyAccess().getGroup(), "rule__MongoProperty__Group__0");
					put(grammarAccess.getMongoOperationAccess().getGroup(), "rule__MongoOperation__Group__0");
					put(grammarAccess.getMongoOperationAccess().getGroup_0(), "rule__MongoOperation__Group_0__0");
					put(grammarAccess.getMongoOperationAccess().getGroup_0_0(), "rule__MongoOperation__Group_0_0__0");
					put(grammarAccess.getMongoOperationAccess().getGroup_1(), "rule__MongoOperation__Group_1__0");
					put(grammarAccess.getMongoOperationAccess().getGroup_1_1(), "rule__MongoOperation__Group_1_1__0");
					...
					put(grammarAccess.getMongoFileAccess().getElementsAssignment(), "rule__MongoFile__ElementsAssignment");
					...
					put(grammarAccess.getMongoOperationAccess().getNameAssignment_0_0_1(), "rule__MongoOperation__NameAssignment_0_0_1");
					put(grammarAccess.getMongoOperationAccess().getParametersAssignment_1_0(), "rule__MongoOperation__ParametersAssignment_1_0");
					put(grammarAccess.getMongoOperationAccess().getParametersAssignment_1_1_1(), "rule__MongoOperation__ParametersAssignment_1_1_1");
					put(grammarAccess.getMongoOperationAccess().getBodyAssignment_3(), "rule__MongoOperation__BodyAssignment_3");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.xtext.mongobeans.ui.contentassist.antlr.internal.InternalMongoBeansParser typedParser = (org.eclipse.xtext.mongobeans.ui.contentassist.antlr.internal.InternalMongoBeansParser) parser;
			typedParser.entryRuleMongoFile();
